    ...
    <nav className="sticky top-0 z-50 bg-white text-dhaba-dark border-b-4 border-dhaba-mustard shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center gap-8 font-sans font-bold text-sm uppercase tracking-widest">
            <a href="#highlights" className="hover:text-dhaba-red transition-colors">Highlights</a>
            <a href="#lounge" className="hover:text-dhaba-red transition-colors">Lounge</a>
            <a href="#groups" className="hover:text-dhaba-red transition-colors">Groups</a>
            <a href="#location" className="hover:text-dhaba-red transition-colors">Find Us</a>
            <a 
      ...
      {isOpen && (
        ...
        >
          <a href="#highlights" className="text-dhaba-dark hover:text-dhaba-red" onClick={() => setIsOpen(false)}>HIGHLIGHTS</a>
          <a href="#lounge" className="text-dhaba-dark hover:text-dhaba-red" onClick={() => setIsOpen(false)}>LOUNGE</a>
          <a href="#groups" className="text-dhaba-dark hover:text-dhaba-red" onClick={() => setIsOpen(false)}>GROUPS</a>
          <a href="#location" className="text-dhaba-dark hover:text-dhaba-red" onClick={() => setIsOpen(false)}>FIND US</a>
          <a 
            href="https://www.google.com/maps/place/HIGHWAY+HAVEN/@29.1562933,77.0342687,17z/data=!3m1!4b1!4m6!3m5!1s0x390dc900750c276f:0x3848e514f5da0fc4!8m2!3d29.1562933!4d77.0342687!16s%2Fg%2F11wwhd7gjp?entry=ttu&g_ep=EgoyMDI2MDQwMS4wIKXMDSoASAFQAw%3D%3D" 
            target="_blank" 
            rel="noopener noreferrer"
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <h1 className="font-display text-6xl md:text-8xl text-white leading-none mb-6 tracking-tighter">
            THE ULTIMATE <span className="text-dhaba-mustard font-serif italic">HIGHWAY</span> EXPERIENCE
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-dhaba-cream/80 text-xl mb-12 leading-relaxed font-light">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              {facilities.map((f, idx) => (
                <div key={idx} className="flex items-start gap-4 group">
                  <div className="bg-[repeating-linear-gradient(45deg,#B91C1C,#B91C1C_4px,#EAB308_4px,#EAB308_8px)] p-[3px] rounded-xl group-hover:scale-110 transition-transform shadow-lg">
                    <div className="bg-dhaba-mustard p-3 rounded-[10px] text-dhaba-dark">
                      {f.icon}
                    </div>
                  </div>
                  <div>
                    <h4 className="font-display text-xl text-dhaba-mustard">{f.name}</h4>
                    <p className="text-dhaba-cream/60">{f.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="rounded-[40px] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-dhaba-dark/40 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="font-serif italic text-2xl text-white">Experience Highway Luxury</p>
                </div>
              </div>
            </div>
          </div>
    ...
    >
      ...
      <div className="absolute inset-0 p-7 flex flex-col justify-end pointer-events-none text-left">
        ...
        >
          ...
          <div 
            className="opacity-0 group-hover:opacity-100 transition-all duration-500 delay-100 h-0 group-hover:h-auto overflow-hidden"
          >
            <p className="font-sans text-white/80 text-xs sm:text-sm leading-tight max-w-[90%]">
              {brand.subtitle}
            </p>
          </div>
        </motion.div>
...
const Brands = () => {
  const brands = [
    ...
    { 
      name: "The Gourmet Villa", 
      logo: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=1000&auto=format&fit=crop", 
      subtitle: "Multi-cuisine premium dining."
    },
    { 
    ...
    <section className="py-32 bg-dhaba-cream overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24">
          ...
          <h2 className="font-display text-5xl md:text-7xl text-dhaba-dark mt-4 tracking-tight leading-none">WORLD-CLASS BRANDS</h2>
